    ...
    for entry in bundle.get("entry", []):
        ...
        if rtype == "Patient":
            ...
            patients.append((
                ...
                resource.get("gender"),
                (resource.get("extension") or [{}])[0].get("valueString"),  # best-effort; race/ethnicity extensions vary
                None,  # ethnicity placeholder (Synthea stores as extension; refine if needed)
                " ".join(name.get("given", [])),
                name.get("family"),
